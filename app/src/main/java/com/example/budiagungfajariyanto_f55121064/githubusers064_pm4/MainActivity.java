package com.example.budiagungfajariyanto_f55121064.githubusers064_pm4;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                switch (statusCode) {
                    case 401:
                        ...
                        break;
                    case 403:
                        errorMessage = statusCode + " : Bad Forbidden";
                        break;
                    case 404:
